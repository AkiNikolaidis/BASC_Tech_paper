...
# CovB   : the number of observations X the number of within individual covariances, e.g. age, sex (see the Notice below for more information)
# CovW   : the number of observations X the number of between indiviudal covariances, e.g. meanFD, global-metric  
...
InputName<-'/Users/aki.nikolaidis/Dropbox/1_Projects/1_Research/BASC_Tech/Code/demo_data.mat'
InputName <- args[1]
OutputName <- args[2]
